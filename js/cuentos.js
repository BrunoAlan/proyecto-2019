...
while(variablecontrol<=totalPasos) { 
 ...
 abutton1.addEventListener("click",function(){opcionCorrecta()},false); //llamo a la funcion al clickear
 ...
 abutton2.addEventListener("click",function(){opcionIncorrecta()},false); //llamo a la funcion al clickear
 ...
 generarmodal.appendChild(div1).appendChild(div2).appendChild(a);
...
function opcionCorrecta() {
 ...
 setTimeout(function(){ avanzarEjercicio(nropaso);  }, 1000); //avanzo en el ejercicio
}
...
function finalEjercicio() {
 var faseActual=faseActualCuento;
    ...
    if (faseActual=="Lectura") {
     ...
     setTimeout(function(){ location.href ="configuracionCuentos.html";  }, 1500);
